    ...
    <table class="table display"  id="table" style="font-family:'Times New Roman', Times, serif; font-size: 12px;width: 100%">
      <thead class="teal white-text">
        <tr class="rowhead">
          ...
          <th class="center align-center">Nama Barang</th>
          <th class="center align-center">Dipesan Oleh</th>
          <th class="center align-center">Diserahkan Oleh</th>
          <th class="center align-center">Tanggal</th>
      ...
      <div class="col s12 l12">
        <div class="row">
          <div class="input-field col l8 s12">
            <input name="nama_file" type="text" id="user_n" class="validate" required>
            <label class="active" for="user_n">Kepada</label>
          </div>  
        ...
        <div class="row">
          <div class="input-field col s12 l12" >
            <select name="url" class="validate" required>
            ...
            <label class="active"  style="top: -14px;">Folder</label>
          </div>
        </div>
        <div class="row">
