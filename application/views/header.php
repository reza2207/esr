  ...
  <html>
    ...
    <body>
      ...
      <ul id="slide-out" class="sidenav sidenav-fixed brown darken-4" style="width:200px;">
        ...
        <li>
          <div class="user-view">
            ...
            <div>
            <img id="img-user" class="circle responsive-img tooltip-red" src="gambar/profile/<?= $this->User_model->get_user($_SESSION['username'])->profil_pict;?>">
            </div>
        ...
        <div id="header-side">
          <ul class="collapsible">
            ...
            <hr>
            <li class="<?= current_active($title, 'Persekot');?> collapsible-head">
              <div class="collapsible-header waves-effect" style="padding-left: 0px !important;color: white"><i class="fa fa-caret-down right <?= caretup($page, 'bag_umum');?>"></i>Bag. Umum
              </div>
              <ul class="collapsible-body">
                <li class="<?= current_active($title, 'Log Kerja Bag. Umum');?>">
                  <a href="<?= base_url().'stock_opname_umum';?>">Stock Opname</a>
                </li>
              </ul>
              <ul class="collapsible-body">
                <li class="<?= current_active($title, 'Log Kerja Bag. Umum');?>">
              ...
              <ul class="collapsible-body">
                <li class="<?= current_active($title, 'Log Kerja Bag. Umum');?>">
                  <a href="<?= base_url().'maintenance';?>">Log Kerja<span class="new badge red" data-badge-caption="">2</span></a>
                </li>
              </ul>
              <ul class="collapsible-body">
                <li class="<?= current_active($title, 'Log Kerja Bag. Umum');?>">
            ...
            <hr>
            <li class="<?= current_active($title, 'Persekot');?> collapsible-head">
              <div class="collapsible-header waves-effect" style="padding-left: 0px !important;color: white"><i class="fa fa-caret-down right <?= caretup($page, 'log kerja');?>"></i>ATK
              </div>
              <ul class="collapsible-body">
                <li class="<?= current_active($title, 'Log Kerja Bag. Umum');?>">
