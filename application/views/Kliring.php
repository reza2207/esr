    ...
    <table class="table display"  id="table" style="font-family:'Times New Roman', Times, serif; font-size: 12px;width: 100%">
      <thead class="teal white-text">
        <tr class="rowhead">
          ...
          <th class="center align-center">Perihal</th>
          <th class="center align-center">Tujuan</th>
          <th class="center align-center">Penerima</th>
          <th class="center align-center">Tgl. Terima</th>
  ...
  $(document).ready(function(){
    ...
    $('#update').on('click', function(){
      ...
      swal({
        ...
        $.ajax({
          type: 'POST',
          url: '<?= base_url()."bar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ang_in/update";?>',
