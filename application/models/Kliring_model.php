 ...
 * @extends CI_Model
 */
class Kliring_model extends CI_Model {

	var $table = 'kliring';
    var $column_order = array('id', 'no_surat', 'tgl_surat', 'perihal', 'tujuan', 'penerima', 'tgl_terima', 'created_by');//,'status');
    //field yang ada di table user
	var $column_search = array('id', 'no_surat', 'tgl_surat', 'perihal', 'tujuan', 'penerima', 'tgl_terima', 'created_by');//,'status');//field yang dizinkan untuk pencarian
	...
	{
		$this->db->select('`id`, `no_surat`, `tgl_surat`, `tujuan`, `penerima`, `tgl_terima`, `created_at`, `created_by`, `deleted_at`, `perihal`');
		$this->db->from($this->table);
		$this->db->where('kliring.deleted_at', null);
